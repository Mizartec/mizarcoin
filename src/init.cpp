...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/mizarcoin-project/mizarcoin>";
    const std::string URL_WEBSITE = "<https://mizarcoin.org>";
