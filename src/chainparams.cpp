...
{
    const char* pszTimestamp = "new era begins for Mizar";
    const CScript genesisOutputScript = CScript() << ParseHex("077784710fa689ad5023690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.nPowTargetTimespan = 60 * 24; // 3.5 days
        consensus.nPowTargetSpacing = 1.0 * 60;
        consensus.fPowAllowMinDifficultyBlocks = false;
        consensus.fPowNoRetargeting = false;
        consensus.nRuleChangeActivationThreshold = 1152; // 75% of 8064
        ...
        genesis = CreateGenesisBlock(1700590000, 2000118904, 0x1e0ffff0, 1, 6000 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xb7ef9200614237c02167ea79b574dbadc0c46c93aceb0d6e5d8b2cf88b255546"));
        assert(genesis.hashMerkleRoot == uint256S("0x989bbe6373906b61177b84fdd5e7c46408e4ef656978b62eca12218905d378aa"));

        // Note that of those with the service bits flag, most only support a subset of possible options
        vSeeds.push_back(CDNSSeedData("104.194.78.73", "104.194.78.73", true));
        vSeeds.push_back(CDNSSeedData("104.244.89.175", "104.244.89.175", true));
        vSeeds.push_back(CDNSSeedData("138.128.221.190", "138.128.221.190", true));
        //vSeeds.push_back(CDNSSeedData("mizarcoinpool.org", "dnsseed.mizarcoinpool.org"));
        ...
        checkpointData = (CCheckpointData) {
            ...
            (  0, uint256S("0xb7ef9200614237c02167ea79b574dbadc0c46c93aceb0d6e5d8b2cf88b255546"))
        ...
        chainTxData = ChainTxData{
            ...
            1700590000, // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
        ...
        consensus.powLimit = uint256S("00000fffffffffffffffffffffffffffffffffffffffffffffffffffffffffff");
        consensus.nPowTargetTimespan = 24 * 60; // 3.5 days
        consensus.nPowTargetSpacing = 1.0 * 60;
        consensus.fPowAllowMinDifficultyBlocks = true;
        consensus.fPowNoRetargeting = false;
        consensus.nRuleChangeActivationThreshold = 1152; // 75% for testchains
...
*/
        ...
        genesis = CreateGenesisBlock(1700590000, 512000, 0x1e0ffff0, 1, 6000 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xbe9e47bcafd4be8496306dc0af0ceb4ba2e4cf7925320b076ccda536f63fcefa"));
        assert(genesis.hashMerkleRoot == uint256S("0x989bbe6373906b61177b84fdd5e7c46408e4ef656978b62eca12218905d378aa"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        vSeeds.push_back(CDNSSeedData("104.194.78.73", "104.194.78.73"));
        //vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-b.mizarcoin.loshan.co.uk", true));
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            ( 0, uint256S("0xbe9e47bcafd4be8496306dc0af0ceb4ba2e4cf7925320b076ccda536f63fcefa")),
        };
...
*/
        ...
        genesis = CreateGenesisBlock(1700590000, 0, 0x207fffff, 1, 6000 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x34e7c7ac5063afdcceaec89e35b198b266b73b15042252f2921f23f65412f80e"));
        assert(genesis.hashMerkleRoot == uint256S("0x989bbe6373906b61177b84fdd5e7c46408e4ef656978b62eca12218905d378aa"));
        ...
        checkpointData = (CCheckpointData){
            boost::assign::map_list_of
            ( 0, uint256S("0x34e7c7ac5063afdcceaec89e35b198b266b73b15042252f2921f23f65412f80e"))
        };
