...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s mizarcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  mizarcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded mizarcoin transaction") + "\n" +
              "  mizarcoin-tx [options] -create [commands]   " + _("Create hex-encoded mizarcoin transaction") + "\n" +
              "\n";
